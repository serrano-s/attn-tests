{
  ...
  "vocabulary": {
    "directory_path": "/homes/gws/sofias6/vocabs/amazon-lowercase-vocab"
  },
  ...
  "validation_data_path": "/homes/gws/sofias6/data/amazon_dev.tsv",
    "model": {
        "type": "flan",
        "pre_document_encoder_dropout": 0.42016423400055152,
        "text_field_embedder": {
            "token_embedders": {
                "tokens": {
                    "type": "embedding",
    ...
    "iterator": {
        ...
        "batch_size": 64,
        "maximum_samples_per_batch": ["num_tokens", 135000],  // confirmed that this affects batch size
        "biggest_batch_first": false
    },
     "trainer": {
        "optimizer": {
            "type": "adam",
            "lr": 0.0004173959621856714
        },
